...
| `NEXORA_NEXUS_ROOT` | Path to the root Nexus install. Read by external control planes to locate a Nexus deployment; safe to ignore when embedding Nexus directly. | `/opt/nexus` |
